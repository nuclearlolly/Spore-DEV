...
<div class="card mt-5">
    ...
    <div class="card-body row p-0 m-auto w-100">
        ...
        @if($step > 0)
        <div class="col-lg-2 col-6 w-100 {{ ($step > ($timer->step ?? 0)) ? : '' }} text-center justify-content-center border p-0">
            <div class="row w-100 p-1 m-auto {{ ($step <= ($timer->step ?? 0)) ? 'btn-primary' : ' border' }}">
