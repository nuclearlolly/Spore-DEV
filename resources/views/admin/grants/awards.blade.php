...
@section('admin-content')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0">Character Grants</h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group d-flex align-items-center no-gutters">
                        <div class="col-md-2">{!! Form::label('data', 'Reason (Optional)') !!} {!! add_help('A reason for the grant. This will be noted in the logs and in the awardcase description.') !!}</div>
