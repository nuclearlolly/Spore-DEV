    ...
    <div class="card mb-4">
        ...
        <div class="card-footer">
            <div class="d-flex flex-sm-row flex-column align-items-center justify-content-between">
                <span class="text-center text-sm-right mx-4 my-2"><b>You can hide this pop-up by clicking the button at the right. If you miss it, you can change its visibility back in <a href="{{ url('account/settings') }}">your
                            settings</a>.</b></span>
